...
$pass        = '3sc4rl4t4';                // Set the password.
...
$msg        = 'Contraseña incorrecta.';    // Optional change: Error message displayed when password is incorrect. Default is "Password incorrect".
